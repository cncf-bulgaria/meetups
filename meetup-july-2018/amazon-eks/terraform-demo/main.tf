...
variable "cluster-name" {
  default = "cncf-bulgaria-eks-demo"
  type    = "string"
}
...
resource "aws_vpc" "demo" {
  ...
  tags = "${
    map(
     "Name", "cncf-bulgaria-eks-demo-node",
...
resource "aws_iam_role" "demo-cluster" {
  name = "cncf-bulgaria-eks-demo-cluster"
...
resource "aws_launch_configuration" "demo" {
  ...
  name_prefix                 = "cncf-bulgaria-eks-demo"
